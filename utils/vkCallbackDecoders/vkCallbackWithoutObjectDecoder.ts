...
export interface VkCallbackRequestWithoutObject<
  Type extends string,
...
const vkCallbackWithoutObjectRequestDecoder = <
  Type extends string,
  Secret extends string,
  GroupId extends number
>(
  ...
  secret: Secret,
  groupId: GroupId
): JsonDecoder.Decoder<VkCallbackRequestWithoutObject<Type, Secret, GroupId>> =>
  JsonDecoder.object(
    {
